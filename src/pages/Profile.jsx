...
export default function Profile() {
  return (
    <section className="profile">
     ...
     digital products and tech projects. A bit more about me: I studied Architecture at the Polytechnic University of Valencia and 
     specialised in management of cultural/educational projects and historic-heritage restoration.
     </p>
     <p>
     ...
     I recently completed the Full-Stack Development bootcamp at The Bridge, where I learned technologies such as HTML, CSS, JavaScript, React, and Node.js, also 
